                    ...
                    <div class="dest-card">
                        ...
                        <div class="dest-info">
                            ...
                            <div class="dest-footer">
                                ...
                                <button type="button" class="btn-dest" data-id="{{ $item->id_wisata }}"
            ...
            <div class="tentang-wrap">
                <div class="tentang-logo-box">
                    <div class="logo-circle">
                        <img src="{{ asset('assets/images/logo-jember.png') }}" alt="Logo Jember"
                ...
                <div class="tentang-content">
                    ...
                    <p class="tentang-desc">
                        J-TRIP adalah platform digital terpercaya yang dirancang untuk memudahkan wisatawan di Kabupaten
                        Jember. Kami hadir sebagai solusi nyata bagi wisatawan lokal maupun mancanegara.
                    </p>
                    <p class="tentang-desc">
                        Dengan fokus pada kemudahan akses, keamanan transaksi, dan promosi destinasi lokal yang
                        berkembang, J-TRIP berkomitmen untuk meningkatkan pengalaman berwisata yang tak terlupakan
...
">
    ...
    ">
            ...
            <span
                style="font-size:.82rem; font-weight:700; color:#1a7a5e; border-bottom:2.5px solid #1a7a5e; padding-bottom:2px;">Wisata</span>
            <button onclick="closeDetailSlide()"
                style="
        ...
        ">
                ...
                <div style="display:flex; gap:0; padding:10px 22px 28px; flex-wrap:wrap; align-items:flex-start;">
                    ...
                    ">
                            ...
                            <div style="position:absolute; top:11px; left:11px; display:flex; gap:5px;"
                                id="detailBadges"></div>
                        </div>
                        ...
                        <div style="display:flex; gap:9px; margin-top:11px; align-items:center;">
                            <div style="width:80px; height:64px; border-radius:10px; overflow:hidden; cursor:pointer; flex-shrink:0; border:2px solid #e5e7eb; transition:border-color .2s, transform .2s;"
                                ...
                                <img id="detailThumbImg1" src="" alt=""
                                    style="width:100%; height:100%; object-fit:cover;" onclick="switchMainImg(this)">
                            </div>
                            <div style="width:80px; height:64px; border-radius:10px; overflow:hidden; cursor:pointer; flex-shrink:0; border:2px solid #e5e7eb; transition:border-color .2s, transform .2s;"
                                onmouseover="this.style.borderColor='#1a7a5e';this.style.transform='scale(1.04)'"
                                onmouseout="this.style.borderColor='#e5e7eb';this.style.transform='scale(1)'">
                        ...
                        "
                                ...
                                <span
                                    style="font-size:.58rem; font-weight:700; color:#9ca3af; letter-spacing:.3px; text-align:center; line-height:1.2;">TAMPILKAN<br>LEBIH</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="flex:1; min-width:260px; padding-left:28px; padding-top:4px;">
                        <h2 id="detailTitle"
                            style="font-size:1.65rem; font-weight:900; line-height:1.15; color:#111827; margin:0 0 13px; letter-spacing:-.5px;">
                        </h2>
                        <p id="detailDesc" style="font-size:.8rem; color:#6b7280; line-height:1.78; margin:0 0 18px;">
                        </p>

                        <div
                            style="display:flex; align-items:center; justify-content:space-between; margin-bottom:18px; padding:12px 16px; background:#f0fdf4; border-radius:10px; border:1px solid #bbf7d0;">
                            <span style="font-size:.78rem; color:#374151; font-weight:600;">Harga Tiket</span>
                            <div style="text-align:right; line-height:1.1;">
                                <span id="detailPrice"
                                    style="font-size:1.1rem; font-weight:900; color:#1a7a5e;"></span>
                        ...
                        <div style="margin-bottom:14px;">
                            <label
                                style="display:block; font-size:.65rem; font-weight:700; color:#374151; letter-spacing:.6px; text-transform:uppercase; margin-bottom:7px;">Pilih
                                Tanggal</label>
                            <div style="position:relative; display:flex; align-items:center;">
                                ...
                                <input type="date" id="detailDate"
                                    style="width:100%; padding:10px 12px 10px 34px; border:1.5px solid #d1d5db; border-radius:9px; font-size:.82rem; font-family:inherit; color:#374151; outline:none; background:#fff; box-sizing:border-box; transition:border-color .2s;"
                        ...
                        <div style="margin-bottom:22px;">
                            <label
                                style="display:block; font-size:.65rem; font-weight:700; color:#374151; letter-spacing:.6px; text-transform:uppercase; margin-bottom:7px;">Jumlah</label>
                            <div
                                style="display:inline-flex; align-items:center; border:1.5px solid #d1d5db; border-radius:9px; overflow:hidden; background:#fff;">
                                <button onclick="changeQty(-1)"
                                    style="width:40px; height:40px; border:none; background:#f9fafb; font-size:1.15rem; cursor:pointer; color:#374151; font-weight:700; line-height:1; transition:background .15s; border-right:1.5px solid #e5e7eb;"
                                    onmouseover="this.style.background='#f3f4f6'"
                                    onmouseout="this.style.background='#f9fafb'">−</button>
                                <span id="detailQty"
                                    style="min-width:44px; text-align:center; font-size:.95rem; font-weight:800; color:#111827;">02</span>
                                <button onclick="changeQty(1)"
                                    style="width:40px; height:40px; border:none; background:#f9fafb; font-size:1.15rem; cursor:pointer; color:#374151; font-weight:700; line-height:1; transition:background .15s; border-left:1.5px solid #e5e7eb;"
                                    onmouseover="this.style.background='#f3f4f6'"
                                    onmouseout="this.style.background='#f9fafb'">+</button>
                            </div>
                        </div>
                        ...
                        <div
                            style="display:flex; align-items:center; justify-content:space-between; margin-bottom:18px; padding:10px 16px; background:#f9fafb; border-radius:9px; border:1px dashed #d1d5db;">
        ...
        function openModalFromBtn(btn) {
            ...
            const data = {
                ...
                mapsUrl: w.lat && w.lng ?
                    ...
                    "https://www.google.com/maps/search/?api=1&query=" + encodeURIComponent(w.nama + " " + (w.lokasi ||
                        "Jember"))
            };
    ...
    {{-- ===== OVERLAY GELAP ===== --}}
    <div id="paymentOverlay" onclick="closePayment()"
        style="
    display:none;
    position:fixed;
    top:0; left:0; right:0; bottom:0;
...
">
        <div
            style="display:flex; align-items:center; justify-content:space-between; padding:0 24px; height:52px; background:#fff; border-bottom:1px solid #e5e7eb; position:sticky; top:0; z-index:10;">
            <button onclick="closePayment()"
                style="display:flex;align-items:center;gap:6px;background:none;border:none;cursor:pointer;font-size:.82rem;color:#374151;font-family:inherit;padding:6px 8px;border-radius:8px;transition:background .15s;"
                onmouseover="this.style.background='#f3f4f6'" onmouseout="this.style.background='none'">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="none"
            ...
            <div style="display:flex;align-items:center;gap:6px;">
                ...
                <span style="font-size:.72rem;font-weight:700;color:#6b7280;letter-spacing:.8px;">SECURE
                    CHECKOUT</span>
            </div>
        </div>
        ...
        <div style="display:flex;overflow:hidden;min-height:520px;max-height:calc(90vh - 52px);">
            ...
            <div style="flex:1;padding:28px 32px;border-right:1px solid #f3f4f6;min-width:0;overflow-y:auto;">
                ...
                <div
                    style="padding:18px;border:1.5px solid #e5e7eb;border-radius:14px;background:#fff;margin-bottom:18px;">
                    <p
                        style="font-size:.68rem;font-weight:800;color:#9ca3af;letter-spacing:.8px;text-transform:uppercase;margin:0 0 8px;">
                        Destinasi
                    </p>
                    <h3 id="payNamaDestinasiLeft"
                        style="font-size:1.15rem;font-weight:900;color:#111827;margin:0;line-height:1.35;"></h3>
                </div>
                ...
                <div
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px;">
                        <div>
                            <p
                                style="font-size:.68rem;font-weight:800;color:#9ca3af;letter-spacing:.8px;text-transform:uppercase;margin:0 0 5px;">
                                Tanggal Kunjungan
                            </p>
                            <p id="payTanggalLeft" style="font-size:.9rem;font-weight:800;color:#111827;margin:0;">
                            </p>
                        </div>

                        <div
                            style="width:38px;height:38px;border-radius:50%;background:#f0fdf4;display:flex;align-items:center;justify-content:center;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="none"
                                viewBox="0 0 24 24" stroke="#1a7a5e" stroke-width="2">
                                <rect x="3" y="4" width="18" height="18" rx="2" />
                                <line x1="16" y1="2" x2="16" y2="6" />
                                <line x1="8" y1="2" x2="8" y2="6" />
                                <line x1="3" y1="10" x2="21" y2="10" />
                ...
                <div
                    style="padding:20px;border-radius:16px;background:#f0fdf4;border:1.5px solid #bbf7d0;margin-bottom:18px;">
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:flex-end;">
                        ...
                        <div style="text-align:right;">
                            <div id="payTotalLeft"
                                style="font-size:1.65rem;font-weight:900;color:#1a7a5e;line-height:1;"></div>
                            <div
                                style="font-size:.62rem;font-weight:800;color:#1a7a5e;letter-spacing:.6px;margin-top:5px;">
                                VIA MIDTRANS
                            </div>
                        </div>
                    </div>
                ...
                <div
                    style="display:flex;gap:13px;align-items:flex-start;padding:14px 18px;background:#fff;border-radius:12px;border:1px solid #e5e7eb;">
            ...
            <div style="width:340px;flex-shrink:0;position:relative;display:flex;flex-direction:column;">
                ...
                <div
                    style="position:absolute;inset:0;background:linear-gradient(to top, rgba(0,0,0,.78) 0%, rgba(0,0,0,.25) 48%, rgba(0,0,0,.08) 100%);">
                </div>

                <div
                    style="position:relative;z-index:2;display:flex;flex-direction:column;justify-content:space-between;height:100%;padding:24px;">
                    <div>
                        <p
                            style="font-size:.7rem;font-weight:700;color:rgba(255,255,255,.8);margin:0 0 6px;letter-spacing:.8px;text-transform:uppercase;">
                            Destinasi Pilihan
                        </p>
                        <h3 id="payNamaDestinasi"
                            style="font-size:1.25rem;font-weight:900;color:#fff;margin:0;line-height:1.4;"></h3>
                    </div>

                    <div
                        style="background:rgba(255,255,255,.13);backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,.18);border-radius:16px;padding:18px;">
                        ...
                        <button onclick="prosesPembayaranMidtrans()"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none"
                                viewBox="0 0 24 24" stroke="#1a4a2e" stroke-width="2.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14M12 5l7 7-7 7" />
                            </svg>
                        </button>

                        <p
                            style="font-size:.65rem;color:rgba(255,255,255,.75);text-align:center;margin:10px 0 0;line-height:1.5;">
    ...
    <div id="stepsOverlay" onclick="closeSteps()"
        style="
    display:none;
    position:fixed;
    top:0; left:0; right:0; bottom:0;
...
">
        {{-- Header --}}
        <div
            style="display:flex;align-items:center;justify-content:space-between;padding:16px 18px;border-bottom:1px solid #f1f5f9;">
            <div>
                <p
                    style="font-size:.65rem;font-weight:700;color:#9ca3af;letter-spacing:.8px;text-transform:uppercase;margin:0 0 3px;">
                    Panduan Pembayaran</p>
                <h3 id="stepsTitle" style="font-size:1.05rem;font-weight:800;color:#1a4a2e;margin:0;"></h3>
            </div>
            <button onclick="closeSteps()"
                style="background:#f3f4f6;border:none;cursor:pointer;width:32px;height:32px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:.9rem;color:#6b7280;transition:background .15s;"
        ...
        <div style="padding:12px 18px 0;">
            <div id="stepsBadge"
                style="display:inline-flex;align-items:center;gap:7px;padding:6px 14px;border-radius:50px;font-size:.75rem;font-weight:700;">
            </div>
        </div>
